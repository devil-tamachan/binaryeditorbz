...
//
// Partly implemented from a MFC CTreeListView control by Gerolf K・nel
...
public:
   ...
   CContainedWindowT< WTL::CTreeViewCtrl > m_ctrlTree;
   CContainedWindowT< WTL::CHeaderCtrl > m_ctrlHeader;
   //
   ...
   //
   WTL::CFont m_fontHeader;                              // Header font
   ...
   WTL::CTreeViewCtrl GetTreeControl() const
   {
      ATLASSERT(::IsWindow(m_ctrlTree));
      return m_ctrlTree;
   }
   WTL::CHeaderCtrl GetHeaderControl() const
   {
   ...
   void _Init()
   {
      ...
      m_ctrlTree.SetFont(WTL::AtlGetDefaultGuiFont());
   ...
   {
      WTL::CDCHandle dc = lptvcd->nmcd.hdc;
      ...
      WTL::CImageList il = m_ctrlTree.GetImageList(TVSIL_NORMAL);
